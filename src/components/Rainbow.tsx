...
import { extend, useFrame, useThree, Node, MeshProps } from '@react-three/fiber'
...
declare module '@react-three/fiber' {
  interface ThreeElements {
    rainbowMaterial: Node<typeof RainbowMaterial & RainbowUniforms, typeof RainbowMaterial>
  }
}

interface RainbowProps extends MeshProps {
  startRadius?: number
  endRadius?: number
  emissiveIntensity?: number
  fade?: number
...
export const Rainbow = forwardRef<Mesh, RainbowProps>(
  ({ startRadius = 0, endRadius = 0.5, emissiveIntensity = 2.5, fade = 0.25, ...props }, fRef) => {
    const material = useRef<typeof RainbowMaterial & RainbowUniforms>(null!)
